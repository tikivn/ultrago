...
import (
	...
	"github.com/tikivn/ultrago/xhttp_client"
	"github.com/tikivn/ultrago/xlogaff"
)

func NewHttpExecutor() xhttp_client.HttpExecutor {
...
func NewHttpExecutorWithRes(mockRes map[string][]byte, mockErr map[string]error) xhttp_client.HttpExecutor {
